...
#ifndef CLICK_TCOUNTER_HH
#define CLICK_TCOUNTER_HH
...
TCounter([I<keywords COUNT_CALL, BYTE_COUNT_CALL>])
...
class TCounter : public Element { public:

    TCounter() CLICK_COLD;
    ~TCounter() CLICK_COLD;

    const char *class_name() const		{ return "TCounter"; }
